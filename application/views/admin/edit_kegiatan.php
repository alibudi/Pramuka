                         ...
                         <div class="panel-body" style="padding-bottom:30px;">
                          <div class="col-md-12">
                            ...
                            <label class="col-md-2 control-label text-right">Nama Kegiatan</label>
                              <div class="col-md-10">
                              <input type="text" name="nama_kegiatan" id="nama_kegiatan"  value="<?php echo $kegiatan->nama_kegiatan;?>" class="form-control">
                              </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-2 control-label text-right">Tanggal Kegiatan</label>
                              <div class="col-md-10">
                              <input type="date" name="tgl_kegiatan" id="tgl_kegiatan" value="<?php echo $kegiatan->tgl_kegiatan?>" class="form-control">
                              </div>
                            </div>
                            <div class="form-group">
                            <label class="col-md-2 control-label text-right">Rincian</label>
                              <div class="col-md-10">
                              <input type="text" name="rincian" id="rincian" value="<?php echo $kegiatan->rincian;?>" class="form-control">
                              </div>
                            </div>
